...
GC_INITIAL_HEAP_SIZE=8179869184 /usr/bin/time -v $SEQURE_CODON_PATH/build/codon run -plugin $SEQURE_PATH -plugin $SEQURE_SEQ_PATH $1 scripts/invoke.codon run-$2 ${*:3}
