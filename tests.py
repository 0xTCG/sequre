...
def test_all(mpc: MPCEnv = None, pid: int = None):
    ...
    if mpc is not None and pid is not None:
        ...
        a = Vector([Zp(7), Zp(256), Zp(99), Zp(50)])
        b = Vector([Zp(6), Zp(16), Zp(3), Zp(40)])
        d = mpc.fp_div(a, b)
        float_d_1 = mpc.print_fp_elem(d[0])
        float_d_2 = mpc.print_fp_elem(d[1])
        float_d_3 = mpc.print_fp_elem(d[2])
