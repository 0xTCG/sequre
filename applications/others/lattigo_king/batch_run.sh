...
echo "replace github.com/hhcho/sfgwas-private => ../../../../../libs/go/src/hhcho/sfgwas-private" >> ./go.mod
...
toml set --toml-path='config/matmult/configLocal.Party1.toml' --to-int 'number_of_rows' 8
toml set --toml-path='config/matmult/configLocal.Party2.toml' --to-int 'number_of_rows' 8
